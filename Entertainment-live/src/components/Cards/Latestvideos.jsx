import saif from '../assets/images/Layer 16.png'
import man from '../assets/images/Layer 21.png'

const Latestvideos = () => {
  return (
    <div className='flex flex-row  w-[45%] mx-auto items-start videocardBg rounded-xl p-3 gap-4'>
        <img className='rounded-xl h-full object-cover' src={saif} alt="" />
